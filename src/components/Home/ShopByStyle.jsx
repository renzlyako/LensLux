...
const styles = [
  {
    label: 'Classic', sub: 'Timeless frames for every face',
    to: '/collection?category=Classic',
    img1: classic1, img2: classic2,
  },
  {
    label: 'Sport', sub: 'Built for performance, worn with pride',
    to: '/collection?category=Sport',
    img1: sports1, img2: sports2,
  },
  {
    label: 'Luxury', sub: 'Premium craftsmanship, redefined',
